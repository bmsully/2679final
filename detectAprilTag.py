...
tagWidth = MMMM # measured width of your Apriltag, in meters
...
while True:
    ...
    tags = at_detector.detect(frameGray, estimate_tag_post=True, camera_params=camVector, tag_size=tagWidth)
